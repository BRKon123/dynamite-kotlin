...
object Trainer {
    fun train(network: MultiLayerNetwork, experiences: List<Experience>, epochs: Int, batchSize: Int) {
        val trainingData = DataPreprocessor.preprocessExperiences(network, experiences)
